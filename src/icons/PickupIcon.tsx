export const PickupIcon = () => {
  return (
    ...
    >
      ...
      >
        <path
          d="M2.5 8.5H21.5L19.4 21.5H4.6L2.5 8.5Z"
          fill="white"
          stroke="white"
          strokeWidth="2"
          strokeLinecap="round"
        ...
        />
        <path
          d="M17.5 8.5C17.5 5.1865 15.0375 2.5 12 2.5C8.9625 2.5 6.5 5.1865 6.5 8.5"
          stroke="white"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="M9 16.5C9 16.5 10 18 12 18C14 18 15 16.5 15 16.5"
          stroke="black"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
      ...
      <g mask="url(#mask0_917_1066)">
        <path d="M0 0H24V24H0V0Z" fill="#9BBBFC" />
      </g>
    </svg>
  );
};
